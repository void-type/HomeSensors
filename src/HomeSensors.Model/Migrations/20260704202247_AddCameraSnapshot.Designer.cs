...
namespace HomeSensors.Model.Migrations
{
    ...
    [Migration("20260704202247_AddCameraSnapshot")]
    partial class AddCameraSnapshot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeSensors.Model.CameraSnapshots.Entities.CameraSnapshot", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("SnapshotsPath")
                        .IsRequired()
                    ...
                    b.ToTable("CameraSnapshot", (string)null);
                });
            ...
            modelBuilder.Entity("HomeSensors.Model.Infrastructure.Emailing.Entities.EmailRecipient", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HomeSensors.Model.Temperature.Entities.TemperatureDevice", b =>
                {
                    ...
                    b.Property<bool>("ExcludeFromInactiveAlerts")
                        .HasColumnType("bit");

                    b.Property<int>("InactiveLimitMinutes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeSensors.Model.Temperature.Entities.TemperatureReading", b =>
                {
                    ...
                    b.HasIndex("TemperatureDeviceId", "Time")
                        .HasDatabaseName("IX_TemperatureReadings_DeviceLatest");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TemperatureDeviceId", "Time"), new[] { "TemperatureCelsius", "Humidity", "DeviceBatteryLevel", "TemperatureLocationId" });
            ...
            modelBuilder.Entity("HomeSensors.Model.WaterLeak.Entities.WaterLeakDevice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("WaterLeakDevice", (string)null);
                });
